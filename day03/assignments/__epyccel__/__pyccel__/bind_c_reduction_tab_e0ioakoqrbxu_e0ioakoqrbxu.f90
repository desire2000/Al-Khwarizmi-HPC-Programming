module bind_c_reduction_tab_e0ioakoqrbxu_e0ioakoqrbxu

  use reduction_tab_e0ioakoqrbxu_e0ioakoqrbxu, only: threads_num
  use reduction_tab_e0ioakoqrbxu_e0ioakoqrbxu, only: initialize_table
  use reduction_tab_e0ioakoqrbxu_e0ioakoqrbxu, only: reduction
...
end module bind_c_reduction_tab_e0ioakoqrbxu_e0ioakoqrbxu
