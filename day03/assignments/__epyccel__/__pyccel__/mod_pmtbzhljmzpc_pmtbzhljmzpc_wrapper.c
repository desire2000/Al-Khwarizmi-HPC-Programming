...
static PyMethodDef mod_pmtbzhljmzpc_pmtbzhljmzpc_methods[] = {
    {
        "matrix_prod",
...
static PyModuleDef_Slot mod_pmtbzhljmzpc_pmtbzhljmzpc_slots[] = {
...
static struct PyModuleDef mod_pmtbzhljmzpc_pmtbzhljmzpc_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_pmtbzhljmzpc_pmtbzhljmzpc",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_pmtbzhljmzpc_pmtbzhljmzpc_methods,
    mod_pmtbzhljmzpc_pmtbzhljmzpc_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_pmtbzhljmzpc_pmtbzhljmzpc(void)
{
    import_array();
    return PyModuleDef_Init(&mod_pmtbzhljmzpc_pmtbzhljmzpc_module);
}
