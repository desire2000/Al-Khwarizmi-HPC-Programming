...
static PyMethodDef mod_jscoh4over5e_jscoh4over5e_methods[] = {
    {
        "strassen_multiply",
...
static PyModuleDef_Slot mod_jscoh4over5e_jscoh4over5e_slots[] = {
...
static struct PyModuleDef mod_jscoh4over5e_jscoh4over5e_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_jscoh4over5e_jscoh4over5e",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_jscoh4over5e_jscoh4over5e_methods,
    mod_jscoh4over5e_jscoh4over5e_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_jscoh4over5e_jscoh4over5e(void)
{
    import_array();
    return PyModuleDef_Init(&mod_jscoh4over5e_jscoh4over5e_module);
}
