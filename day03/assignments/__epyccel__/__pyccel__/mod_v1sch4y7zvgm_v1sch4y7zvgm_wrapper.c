...
static PyMethodDef mod_v1sch4y7zvgm_v1sch4y7zvgm_methods[] = {
    {
        "navier_openmp",
...
static PyModuleDef_Slot mod_v1sch4y7zvgm_v1sch4y7zvgm_slots[] = {
...
static struct PyModuleDef mod_v1sch4y7zvgm_v1sch4y7zvgm_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_v1sch4y7zvgm_v1sch4y7zvgm",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_v1sch4y7zvgm_v1sch4y7zvgm_methods,
    mod_v1sch4y7zvgm_v1sch4y7zvgm_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_v1sch4y7zvgm_v1sch4y7zvgm(void)
{
    import_array();
    return PyModuleDef_Init(&mod_v1sch4y7zvgm_v1sch4y7zvgm_module);
}
