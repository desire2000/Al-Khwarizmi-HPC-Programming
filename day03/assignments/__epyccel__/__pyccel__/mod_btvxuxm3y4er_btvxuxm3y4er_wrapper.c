...
static PyMethodDef mod_btvxuxm3y4er_btvxuxm3y4er_methods[] = {
    {
        "strassen_multiply",
...
static PyModuleDef_Slot mod_btvxuxm3y4er_btvxuxm3y4er_slots[] = {
...
static struct PyModuleDef mod_btvxuxm3y4er_btvxuxm3y4er_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_btvxuxm3y4er_btvxuxm3y4er",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_btvxuxm3y4er_btvxuxm3y4er_methods,
    mod_btvxuxm3y4er_btvxuxm3y4er_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_btvxuxm3y4er_btvxuxm3y4er(void)
{
    import_array();
    return PyModuleDef_Init(&mod_btvxuxm3y4er_btvxuxm3y4er_module);
}
