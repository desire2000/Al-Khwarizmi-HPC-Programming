module bind_c_reduction_tab_zvu9e03llglt_zvu9e03llglt

  use reduction_tab_zvu9e03llglt_zvu9e03llglt, only: reduction
  use reduction_tab_zvu9e03llglt_zvu9e03llglt, only: initialize_table
  use reduction_tab_zvu9e03llglt_zvu9e03llglt, only: threads_num
...
end module bind_c_reduction_tab_zvu9e03llglt_zvu9e03llglt
