...
PyObject *navier_openmp_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOO!O!O!O!O!OOOOOO!O!OO", kwlist, &nit_tmp, &nt_tmp, &PyArray_Type, &u_tmp, &PyArray_Type, &un_tmp, &PyArray_Type, &b_tmp, &PyArray_Type, &v_tmp, &PyArray_Type, &vn_tmp, &dt_tmp, &nx_tmp, &ny_tmp, &dx_tmp, &dy_tmp, &PyArray_Type, &p_tmp, &PyArray_Type, &pn_tmp, &rho_tmp, &nu_tmp))
    {
        return NULL;
    }
...
static PyMethodDef mod_iz3774i1r1uc_iz3774i1r1uc_methods[] = {
    {
        "navier_openmp",
...
static PyModuleDef_Slot mod_iz3774i1r1uc_iz3774i1r1uc_slots[] = {
...
static struct PyModuleDef mod_iz3774i1r1uc_iz3774i1r1uc_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_iz3774i1r1uc_iz3774i1r1uc",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_iz3774i1r1uc_iz3774i1r1uc_methods,
    mod_iz3774i1r1uc_iz3774i1r1uc_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_iz3774i1r1uc_iz3774i1r1uc(void)
{
    import_array();
    return PyModuleDef_Init(&mod_iz3774i1r1uc_iz3774i1r1uc_module);
}
