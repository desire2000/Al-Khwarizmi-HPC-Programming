module bind_c_reduction_tab_jlq992v4y4rb_jlq992v4y4rb

  use reduction_tab_jlq992v4y4rb_jlq992v4y4rb, only: threads_num
  use reduction_tab_jlq992v4y4rb_jlq992v4y4rb, only: initialize_table
  use reduction_tab_jlq992v4y4rb_jlq992v4y4rb, only: reduction
...
end module bind_c_reduction_tab_jlq992v4y4rb_jlq992v4y4rb
