module bind_c_reduction_tab_chy33y1tdww9_chy33y1tdww9

  use reduction_tab_chy33y1tdww9_chy33y1tdww9, only: initialize_table
  use reduction_tab_chy33y1tdww9_chy33y1tdww9, only: reduction
  use reduction_tab_chy33y1tdww9_chy33y1tdww9, only: threads_num
...
end module bind_c_reduction_tab_chy33y1tdww9_chy33y1tdww9
