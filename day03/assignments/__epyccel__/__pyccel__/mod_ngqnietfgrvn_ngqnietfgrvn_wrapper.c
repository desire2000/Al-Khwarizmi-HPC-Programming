...
static PyMethodDef mod_ngqnietfgrvn_ngqnietfgrvn_methods[] = {
    {
        "matrix_prod",
...
static PyModuleDef_Slot mod_ngqnietfgrvn_ngqnietfgrvn_slots[] = {
...
static struct PyModuleDef mod_ngqnietfgrvn_ngqnietfgrvn_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_ngqnietfgrvn_ngqnietfgrvn",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_ngqnietfgrvn_ngqnietfgrvn_methods,
    mod_ngqnietfgrvn_ngqnietfgrvn_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ngqnietfgrvn_ngqnietfgrvn(void)
{
    import_array();
    return PyModuleDef_Init(&mod_ngqnietfgrvn_ngqnietfgrvn_module);
}
