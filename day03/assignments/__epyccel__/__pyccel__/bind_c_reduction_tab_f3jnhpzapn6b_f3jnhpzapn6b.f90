module bind_c_reduction_tab_f3jnhpzapn6b_f3jnhpzapn6b

  use reduction_tab_f3jnhpzapn6b_f3jnhpzapn6b, only: initialize_table
  use reduction_tab_f3jnhpzapn6b_f3jnhpzapn6b, only: reduction
  use reduction_tab_f3jnhpzapn6b_f3jnhpzapn6b, only: threads_num
...
end module bind_c_reduction_tab_f3jnhpzapn6b_f3jnhpzapn6b
