...
static PyMethodDef mod_b4v1pa7z9b4s_b4v1pa7z9b4s_methods[] = {
    {
        "matrix_prod",
...
static PyModuleDef_Slot mod_b4v1pa7z9b4s_b4v1pa7z9b4s_slots[] = {
...
static struct PyModuleDef mod_b4v1pa7z9b4s_b4v1pa7z9b4s_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_b4v1pa7z9b4s_b4v1pa7z9b4s",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_b4v1pa7z9b4s_b4v1pa7z9b4s_methods,
    mod_b4v1pa7z9b4s_b4v1pa7z9b4s_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_b4v1pa7z9b4s_b4v1pa7z9b4s(void)
{
    import_array();
    return PyModuleDef_Init(&mod_b4v1pa7z9b4s_b4v1pa7z9b4s_module);
}
