module bind_c_reduction_tab_zs9fff7b6g4x_zs9fff7b6g4x

  use reduction_tab_zs9fff7b6g4x_zs9fff7b6g4x, only: reduction
  use reduction_tab_zs9fff7b6g4x_zs9fff7b6g4x, only: initialize_table
  use reduction_tab_zs9fff7b6g4x_zs9fff7b6g4x, only: threads_num
...
end module bind_c_reduction_tab_zs9fff7b6g4x_zs9fff7b6g4x
