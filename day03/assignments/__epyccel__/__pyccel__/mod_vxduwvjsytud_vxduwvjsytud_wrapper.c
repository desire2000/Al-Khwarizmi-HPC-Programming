...
static PyMethodDef mod_vxduwvjsytud_vxduwvjsytud_methods[] = {
    {
        "matrix_prod",
...
static PyModuleDef_Slot mod_vxduwvjsytud_vxduwvjsytud_slots[] = {
...
static struct PyModuleDef mod_vxduwvjsytud_vxduwvjsytud_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_vxduwvjsytud_vxduwvjsytud",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_vxduwvjsytud_vxduwvjsytud_methods,
    mod_vxduwvjsytud_vxduwvjsytud_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_vxduwvjsytud_vxduwvjsytud(void)
{
    import_array();
    return PyModuleDef_Init(&mod_vxduwvjsytud_vxduwvjsytud_module);
}
