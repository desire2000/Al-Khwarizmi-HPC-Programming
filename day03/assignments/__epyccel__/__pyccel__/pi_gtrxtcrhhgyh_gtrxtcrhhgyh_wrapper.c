...
static PyMethodDef pi_gtrxtcrhhgyh_gtrxtcrhhgyh_methods[] = {
    {
        "f",
...
static PyModuleDef_Slot pi_gtrxtcrhhgyh_gtrxtcrhhgyh_slots[] = {
...
static struct PyModuleDef pi_gtrxtcrhhgyh_gtrxtcrhhgyh_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "pi_gtrxtcrhhgyh_gtrxtcrhhgyh",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    pi_gtrxtcrhhgyh_gtrxtcrhhgyh_methods,
    pi_gtrxtcrhhgyh_gtrxtcrhhgyh_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_pi_gtrxtcrhhgyh_gtrxtcrhhgyh(void)
{
    import_array();
    return PyModuleDef_Init(&pi_gtrxtcrhhgyh_gtrxtcrhhgyh_module);
}
