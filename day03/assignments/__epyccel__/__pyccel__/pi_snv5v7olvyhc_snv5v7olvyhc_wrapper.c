...
static PyMethodDef pi_snv5v7olvyhc_snv5v7olvyhc_methods[] = {
    {
        "f",
...
static PyModuleDef_Slot pi_snv5v7olvyhc_snv5v7olvyhc_slots[] = {
...
static struct PyModuleDef pi_snv5v7olvyhc_snv5v7olvyhc_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "pi_snv5v7olvyhc_snv5v7olvyhc",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    pi_snv5v7olvyhc_snv5v7olvyhc_methods,
    pi_snv5v7olvyhc_snv5v7olvyhc_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_pi_snv5v7olvyhc_snv5v7olvyhc(void)
{
    import_array();
    return PyModuleDef_Init(&pi_snv5v7olvyhc_snv5v7olvyhc_module);
}
