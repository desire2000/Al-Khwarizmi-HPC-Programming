...
static PyMethodDef mod_wb2n8ily50fm_wb2n8ily50fm_methods[] = {
    {
        "strassen_multiply",
...
static PyModuleDef_Slot mod_wb2n8ily50fm_wb2n8ily50fm_slots[] = {
...
static struct PyModuleDef mod_wb2n8ily50fm_wb2n8ily50fm_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_wb2n8ily50fm_wb2n8ily50fm",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_wb2n8ily50fm_wb2n8ily50fm_methods,
    mod_wb2n8ily50fm_wb2n8ily50fm_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_wb2n8ily50fm_wb2n8ily50fm(void)
{
    import_array();
    return PyModuleDef_Init(&mod_wb2n8ily50fm_wb2n8ily50fm_module);
}
