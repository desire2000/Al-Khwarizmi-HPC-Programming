...
static PyMethodDef mod_hquoffrltwzl_hquoffrltwzl_methods[] = {
    {
        "matrix_prod",
...
static PyModuleDef_Slot mod_hquoffrltwzl_hquoffrltwzl_slots[] = {
...
static struct PyModuleDef mod_hquoffrltwzl_hquoffrltwzl_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_hquoffrltwzl_hquoffrltwzl",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_hquoffrltwzl_hquoffrltwzl_methods,
    mod_hquoffrltwzl_hquoffrltwzl_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_hquoffrltwzl_hquoffrltwzl(void)
{
    import_array();
    return PyModuleDef_Init(&mod_hquoffrltwzl_hquoffrltwzl_module);
}
