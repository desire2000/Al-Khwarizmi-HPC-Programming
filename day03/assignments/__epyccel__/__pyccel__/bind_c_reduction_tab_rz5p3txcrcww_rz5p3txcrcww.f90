module bind_c_reduction_tab_rz5p3txcrcww_rz5p3txcrcww

  use reduction_tab_rz5p3txcrcww_rz5p3txcrcww, only: reduction
  use reduction_tab_rz5p3txcrcww_rz5p3txcrcww, only: initialize_table
  use reduction_tab_rz5p3txcrcww_rz5p3txcrcww, only: threads_num
...
end module bind_c_reduction_tab_rz5p3txcrcww_rz5p3txcrcww
