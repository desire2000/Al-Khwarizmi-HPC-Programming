...
static PyMethodDef mod_uwlwgjiajimx_uwlwgjiajimx_methods[] = {
    {
...
static PyModuleDef_Slot mod_uwlwgjiajimx_uwlwgjiajimx_slots[] = {
...
static struct PyModuleDef mod_uwlwgjiajimx_uwlwgjiajimx_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_uwlwgjiajimx_uwlwgjiajimx",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_uwlwgjiajimx_uwlwgjiajimx_methods,
    mod_uwlwgjiajimx_uwlwgjiajimx_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_uwlwgjiajimx_uwlwgjiajimx(void)
{
    import_array();
    return PyModuleDef_Init(&mod_uwlwgjiajimx_uwlwgjiajimx_module);
}
