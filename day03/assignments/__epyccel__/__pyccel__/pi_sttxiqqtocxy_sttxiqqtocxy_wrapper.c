...
static PyMethodDef pi_sttxiqqtocxy_sttxiqqtocxy_methods[] = {
    {
        "f",
...
static PyModuleDef_Slot pi_sttxiqqtocxy_sttxiqqtocxy_slots[] = {
...
static struct PyModuleDef pi_sttxiqqtocxy_sttxiqqtocxy_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "pi_sttxiqqtocxy_sttxiqqtocxy",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    pi_sttxiqqtocxy_sttxiqqtocxy_methods,
    pi_sttxiqqtocxy_sttxiqqtocxy_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_pi_sttxiqqtocxy_sttxiqqtocxy(void)
{
    import_array();
    return PyModuleDef_Init(&pi_sttxiqqtocxy_sttxiqqtocxy_module);
}
