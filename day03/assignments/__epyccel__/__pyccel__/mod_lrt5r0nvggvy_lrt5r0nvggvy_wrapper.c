...
static PyMethodDef mod_lrt5r0nvggvy_lrt5r0nvggvy_methods[] = {
    {
        "strassen_multiply",
...
static PyModuleDef_Slot mod_lrt5r0nvggvy_lrt5r0nvggvy_slots[] = {
...
static struct PyModuleDef mod_lrt5r0nvggvy_lrt5r0nvggvy_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_lrt5r0nvggvy_lrt5r0nvggvy",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_lrt5r0nvggvy_lrt5r0nvggvy_methods,
    mod_lrt5r0nvggvy_lrt5r0nvggvy_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lrt5r0nvggvy_lrt5r0nvggvy(void)
{
    import_array();
    return PyModuleDef_Init(&mod_lrt5r0nvggvy_lrt5r0nvggvy_module);
}
