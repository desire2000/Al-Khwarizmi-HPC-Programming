...
PyObject *matrix_prod_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    Out_0002 = matrix_prod(A, B, C, N, M, threads);
...
{
    reduction_tab_2ktxafgrhlry_2ktxafgrhlry__init();
    return 0;
}

/*........................................*/

static PyMethodDef reduction_tab_2ktxafgrhlry_2ktxafgrhlry_methods[] = {
    {
        "threads_num",
...
static PyModuleDef_Slot reduction_tab_2ktxafgrhlry_2ktxafgrhlry_slots[] = {
...
static struct PyModuleDef reduction_tab_2ktxafgrhlry_2ktxafgrhlry_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "reduction_tab_2ktxafgrhlry_2ktxafgrhlry",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    reduction_tab_2ktxafgrhlry_2ktxafgrhlry_methods,
    reduction_tab_2ktxafgrhlry_2ktxafgrhlry_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_reduction_tab_2ktxafgrhlry_2ktxafgrhlry(void)
{
    import_array();
    return PyModuleDef_Init(&reduction_tab_2ktxafgrhlry_2ktxafgrhlry_module);
}
