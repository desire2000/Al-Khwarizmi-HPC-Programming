module bind_c_reduction_tab_ac8dccnbxo5m_ac8dccnbxo5m

  use reduction_tab_ac8dccnbxo5m_ac8dccnbxo5m, only: initialize_table
  use reduction_tab_ac8dccnbxo5m_ac8dccnbxo5m, only: threads_num
  use reduction_tab_ac8dccnbxo5m_ac8dccnbxo5m, only: reduction
...
end module bind_c_reduction_tab_ac8dccnbxo5m_ac8dccnbxo5m
