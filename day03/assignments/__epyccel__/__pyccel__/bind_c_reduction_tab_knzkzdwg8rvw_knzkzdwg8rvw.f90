module bind_c_reduction_tab_knzkzdwg8rvw_knzkzdwg8rvw

  use reduction_tab_knzkzdwg8rvw_knzkzdwg8rvw, only: reduction
  use reduction_tab_knzkzdwg8rvw_knzkzdwg8rvw, only: initialize_table
  use reduction_tab_knzkzdwg8rvw_knzkzdwg8rvw, only: threads_num
...
end module bind_c_reduction_tab_knzkzdwg8rvw_knzkzdwg8rvw
