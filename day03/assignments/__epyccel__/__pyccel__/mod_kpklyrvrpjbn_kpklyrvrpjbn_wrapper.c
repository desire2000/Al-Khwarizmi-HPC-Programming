...
static PyMethodDef mod_kpklyrvrpjbn_kpklyrvrpjbn_methods[] = {
    {
...
static PyModuleDef_Slot mod_kpklyrvrpjbn_kpklyrvrpjbn_slots[] = {
...
static struct PyModuleDef mod_kpklyrvrpjbn_kpklyrvrpjbn_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_kpklyrvrpjbn_kpklyrvrpjbn",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_kpklyrvrpjbn_kpklyrvrpjbn_methods,
    mod_kpklyrvrpjbn_kpklyrvrpjbn_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_kpklyrvrpjbn_kpklyrvrpjbn(void)
{
    import_array();
    return PyModuleDef_Init(&mod_kpklyrvrpjbn_kpklyrvrpjbn_module);
}
