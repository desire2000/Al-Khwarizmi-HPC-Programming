...
static PyMethodDef mod_cgbuq1eoxtoj_cgbuq1eoxtoj_methods[] = {
    {
        "strassen_multiply",
...
static PyModuleDef_Slot mod_cgbuq1eoxtoj_cgbuq1eoxtoj_slots[] = {
...
static struct PyModuleDef mod_cgbuq1eoxtoj_cgbuq1eoxtoj_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_cgbuq1eoxtoj_cgbuq1eoxtoj",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_cgbuq1eoxtoj_cgbuq1eoxtoj_methods,
    mod_cgbuq1eoxtoj_cgbuq1eoxtoj_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_cgbuq1eoxtoj_cgbuq1eoxtoj(void)
{
    import_array();
    return PyModuleDef_Init(&mod_cgbuq1eoxtoj_cgbuq1eoxtoj_module);
}
