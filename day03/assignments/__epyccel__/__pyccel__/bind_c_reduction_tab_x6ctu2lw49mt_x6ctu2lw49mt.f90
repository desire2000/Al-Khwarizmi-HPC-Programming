module bind_c_reduction_tab_x6ctu2lw49mt_x6ctu2lw49mt

  use reduction_tab_x6ctu2lw49mt_x6ctu2lw49mt, only: reduction
  use reduction_tab_x6ctu2lw49mt_x6ctu2lw49mt, only: initialize_table
  use reduction_tab_x6ctu2lw49mt_x6ctu2lw49mt, only: threads_num
...
end module bind_c_reduction_tab_x6ctu2lw49mt_x6ctu2lw49mt
