module bind_c_reduction_tab_1hye4xnxwbcj_1hye4xnxwbcj

  use reduction_tab_1hye4xnxwbcj_1hye4xnxwbcj, only: initialize_table
  use reduction_tab_1hye4xnxwbcj_1hye4xnxwbcj, only: reduction
  use reduction_tab_1hye4xnxwbcj_1hye4xnxwbcj, only: threads_num
...
end module bind_c_reduction_tab_1hye4xnxwbcj_1hye4xnxwbcj
