...
static PyMethodDef mod_u0w6nlm11nno_u0w6nlm11nno_methods[] = {
    {
        "matrix_prod",
...
static PyModuleDef_Slot mod_u0w6nlm11nno_u0w6nlm11nno_slots[] = {
...
static struct PyModuleDef mod_u0w6nlm11nno_u0w6nlm11nno_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_u0w6nlm11nno_u0w6nlm11nno",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_u0w6nlm11nno_u0w6nlm11nno_methods,
    mod_u0w6nlm11nno_u0w6nlm11nno_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_u0w6nlm11nno_u0w6nlm11nno(void)
{
    import_array();
    return PyModuleDef_Init(&mod_u0w6nlm11nno_u0w6nlm11nno_module);
}
