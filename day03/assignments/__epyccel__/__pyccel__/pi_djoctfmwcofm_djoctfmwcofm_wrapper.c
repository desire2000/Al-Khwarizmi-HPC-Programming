...
static PyMethodDef pi_djoctfmwcofm_djoctfmwcofm_methods[] = {
    {
        "f",
...
static PyModuleDef_Slot pi_djoctfmwcofm_djoctfmwcofm_slots[] = {
...
static struct PyModuleDef pi_djoctfmwcofm_djoctfmwcofm_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "pi_djoctfmwcofm_djoctfmwcofm",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    pi_djoctfmwcofm_djoctfmwcofm_methods,
    pi_djoctfmwcofm_djoctfmwcofm_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_pi_djoctfmwcofm_djoctfmwcofm(void)
{
    import_array();
    return PyModuleDef_Init(&pi_djoctfmwcofm_djoctfmwcofm_module);
}
