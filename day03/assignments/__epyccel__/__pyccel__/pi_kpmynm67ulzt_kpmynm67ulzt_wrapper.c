...
static PyMethodDef pi_kpmynm67ulzt_kpmynm67ulzt_methods[] = {
    {
        "f",
...
static PyModuleDef_Slot pi_kpmynm67ulzt_kpmynm67ulzt_slots[] = {
...
static struct PyModuleDef pi_kpmynm67ulzt_kpmynm67ulzt_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "pi_kpmynm67ulzt_kpmynm67ulzt",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    pi_kpmynm67ulzt_kpmynm67ulzt_methods,
    pi_kpmynm67ulzt_kpmynm67ulzt_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_pi_kpmynm67ulzt_kpmynm67ulzt(void)
{
    import_array();
    return PyModuleDef_Init(&pi_kpmynm67ulzt_kpmynm67ulzt_module);
}
