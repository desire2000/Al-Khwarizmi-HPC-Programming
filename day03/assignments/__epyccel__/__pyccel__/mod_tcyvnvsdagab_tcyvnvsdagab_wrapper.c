...
static PyMethodDef mod_tcyvnvsdagab_tcyvnvsdagab_methods[] = {
    {
        "matrix_prod",
...
static PyModuleDef_Slot mod_tcyvnvsdagab_tcyvnvsdagab_slots[] = {
...
static struct PyModuleDef mod_tcyvnvsdagab_tcyvnvsdagab_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_tcyvnvsdagab_tcyvnvsdagab",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_tcyvnvsdagab_tcyvnvsdagab_methods,
    mod_tcyvnvsdagab_tcyvnvsdagab_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_tcyvnvsdagab_tcyvnvsdagab(void)
{
    import_array();
    return PyModuleDef_Init(&mod_tcyvnvsdagab_tcyvnvsdagab_module);
}
