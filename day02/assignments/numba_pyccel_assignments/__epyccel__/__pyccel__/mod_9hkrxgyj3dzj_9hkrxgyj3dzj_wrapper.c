...
PyObject *solve_2d_burger_pyccel_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O!O!O!O!OOOOO", kwlist, &PyArray_Type, &u_tmp, &PyArray_Type, &un_tmp, &PyArray_Type, &v_tmp, &PyArray_Type, &vn_tmp, &nt_tmp, &dt_tmp, &dx_tmp, &dy_tmp, &nu_tmp))
    {
        return NULL;
    }
...
static PyMethodDef mod_9hkrxgyj3dzj_9hkrxgyj3dzj_methods[] = {
    {
...
static PyModuleDef_Slot mod_9hkrxgyj3dzj_9hkrxgyj3dzj_slots[] = {
...
static struct PyModuleDef mod_9hkrxgyj3dzj_9hkrxgyj3dzj_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_9hkrxgyj3dzj_9hkrxgyj3dzj",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_9hkrxgyj3dzj_9hkrxgyj3dzj_methods,
    mod_9hkrxgyj3dzj_9hkrxgyj3dzj_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_9hkrxgyj3dzj_9hkrxgyj3dzj(void)
{
    import_array();
    return PyModuleDef_Init(&mod_9hkrxgyj3dzj_9hkrxgyj3dzj_module);
}
